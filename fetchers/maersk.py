...
class MaerskFetcher(CompanyFetcher):
    """A.P. Moller-Maersk 爬蟲"""

    company_id = "maersk"
    company_name = "A.P. Moller-Maersk"
    news_url = "https://www.apmoller-maersk.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.apmoller-maersk.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from A.P. Moller-Maersk")
        return documents
