...
class HdKoreaFetcher(CompanyFetcher):
    """HD Korea Shipbuilding 爬蟲"""

    company_id = "hd_korea"
    company_name = "HD Korea Shipbuilding"
    news_url = "https://www.hdkoreashipbuilding.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.hdkoreashipbuilding.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from HD Korea Shipbuilding")
        return documents
