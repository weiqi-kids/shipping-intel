...
class CoscoFetcher(CompanyFetcher):
    """COSCO Shipping 爬蟲"""

    company_id = "cosco"
    company_name = "COSCO Shipping"
    news_url = "https://www.coscoshipping.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.coscoshipping.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from COSCO Shipping")
        return documents
