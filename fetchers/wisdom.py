...
class WisdomFetcher(CompanyFetcher):
    """Wisdom Marine Lines 爬蟲"""

    company_id = "wisdom"
    company_name = "Wisdom Marine Lines"
    news_url = "https://www.wisdommarinelines.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.wisdommarinelines.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Wisdom Marine Lines")
        return documents
