...
class UMingFetcher(CompanyFetcher):
    """U-Ming Marine 爬蟲"""

    company_id = "u_ming"
    company_name = "U-Ming Marine"
    news_url = "https://www.u-mingmarine.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.u-mingmarine.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from U-Ming Marine")
        return documents
