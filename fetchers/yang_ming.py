...
class YangMingFetcher(CompanyFetcher):
    """Yang Ming Marine 爬蟲"""

    company_id = "yang_ming"
    company_name = "Yang Ming Marine"
    news_url = "https://www.yangmingmarine.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.yangmingmarine.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Yang Ming Marine")
        return documents
