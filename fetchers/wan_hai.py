...
class WanHaiFetcher(CompanyFetcher):
    """Wan Hai Lines 爬蟲"""

    company_id = "wan_hai"
    company_name = "Wan Hai Lines"
    news_url = "https://www.wanhailines.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.wanhailines.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Wan Hai Lines")
        return documents
