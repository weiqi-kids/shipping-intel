...
class HanwhaOceanFetcher(CompanyFetcher):
    """Hanwha Ocean 爬蟲"""

    company_id = "hanwha_ocean"
    company_name = "Hanwha Ocean"
    news_url = "https://www.hanwhaocean.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.hanwhaocean.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Hanwha Ocean")
        return documents
