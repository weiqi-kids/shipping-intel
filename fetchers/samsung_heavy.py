...
class SamsungHeavyFetcher(CompanyFetcher):
    """Samsung Heavy Industries 爬蟲"""

    company_id = "samsung_heavy"
    company_name = "Samsung Heavy Industries"
    news_url = "https://www.samsungheavyindustries.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.samsungheavyindustries.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Samsung Heavy Industries")
        return documents
