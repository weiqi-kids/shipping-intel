...
class ZimFetcher(CompanyFetcher):
    """ZIM Integrated Shipping 爬蟲"""

    company_id = "zim"
    company_name = "ZIM Integrated Shipping"
    news_url = "https://www.zimintegratedshipping.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.zimintegratedshipping.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from ZIM Integrated Shipping")
        return documents
