...
class EvergreenFetcher(CompanyFetcher):
    """Evergreen Marine 爬蟲"""

    company_id = "evergreen"
    company_name = "Evergreen Marine"
    news_url = "https://www.evergreenmarine.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.evergreenmarine.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Evergreen Marine")
        return documents
