...
class StarBulkFetcher(CompanyFetcher):
    """Star Bulk Carriers 爬蟲"""

    company_id = "star_bulk"
    company_name = "Star Bulk Carriers"
    news_url = "https://www.starbulkcarriers.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.starbulkcarriers.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Star Bulk Carriers")
        return documents
