...
class CsscFetcher(CompanyFetcher):
    """China State Shipbuilding 爬蟲"""

    company_id = "cssc"
    company_name = "China State Shipbuilding"
    news_url = "https://www.chinastateshipbuilding.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.chinastateshipbuilding.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from China State Shipbuilding")
        return documents
